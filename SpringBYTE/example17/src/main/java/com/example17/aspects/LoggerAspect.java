...
public class LoggerAspect {
    ...
    @Around("execution(* com.example17.services.*.*(..))")
    ...
    @Around("@annotation(com.example17.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* com.example17.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.example17.services.*.*(..))",returning = "retVal")
