...
public class LoggerAspect {
    ...
    @Around("execution(* com.example.Demo10.service.*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.example.Demo10.service.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.example.Demo10.service.*.*(..))",returning = "retVal")
	...
	@Around("@annotation(com.example.Demo10.Interface.LogAspect)")
