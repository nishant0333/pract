...
public class CustomerDAOImpl implements CustomerDAO {
	...
	/*
	 * @Override public List<Customer>getCustomersByEmail(String email) { String
	 * SQL="select * from mycustomers where email=?"; List<Customer> mylist =
	 * jtemp.query(SQL, new CustomerRowMapper(),email); return mylist;
	 */
